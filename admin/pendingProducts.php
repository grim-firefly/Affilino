...
<div class="row mt-2">
    <div class="container-fluid ">
        <a href="products.php" class="btn btn-info btn-sm  float-right ">Products</a>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                for ($i = 0; $i < count($data); $i++) {
                    ...
                    echo '<td>';
                    echo '<a href="productDetails.php?id=' . $data[$i]['id'] . '&url=pendingProducts.php" class="btn btn-sm btn-info">View</a>';
                    echo '<a href="pendingProducts.php?id=' . $data[$i]['id'] . '&command=approve" class="btn btn-sm btn-warning">Approve</a>';
                    echo '<a href="pendingProducts.php?id=' . $data[$i]['id'] . '&command=reject" class="btn btn-sm btn-danger">Reject</a>';
                    echo '</td>';
