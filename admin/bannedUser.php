...
<div class="row mt-2">
    <div class="container-fluid ">
        <a href="pendingUser.php" class="btn btn-warning btn-sm float-right ml-2">Pending User</a>
        <a href="users.php" class="btn btn-info btn-sm  float-right ">Approved User</a>
