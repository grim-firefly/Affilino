...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light landingpageNav" id="navbar">
    <a class="navbar-brand ml-5 nav_logo_text text-light font-weight-bold " href="#">Affilino</a>
            ...
            <div class="col landingpageTxtContainer">
              <div class="landingpageTxt">
                ...
                <p>Best-in-class sales & marketing automation platform and marketplace for digital business owners and
                  online marketers</p>
                <div class="row pl-3">
                  <a class="btn btn-info topsectionbtn mr-3" href="features.php"><span>Learn More</span></a>
          ...
          <div class="feedback__box_container">
            ...
            <div class="feedback__bottom">
              <div class="feedback__box_img">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTL8gPRDx9iWXZx2GcScvJ2EDW6BoESX-KzdA&usqp=CAU"
                  alt="">
              </div>
        ...
        <div class="col">
          <div class="feedback__box_container">
            ...
            <div class="feedback__bottom">
              <div class="feedback__box_img">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTixlJF4i1aprDaX6yEfTBhiB-3jZ_kfmvAjg&usqp=CAU"
                  alt="">
              </div>
              <div class="feedback__box_title_container">
                <h5>Art Flair</h5>
        ...
        <div class="row">
          ...
          <div class="col footer-quickLink">
            ...
            <ul style="list-style: none;">
              ...
              <li><a class="text-light" href="#">Features</a></li>
